...
from api.routes.product_batches import router as production_batches_router
...
async def request_timeout_middleware(request: Request, call_next):
    ...
    try:
        ...
        return JSONResponse(status_code=504,
            content=error_payload("Request timed out", "REQUEST_TIMEOUT", f"Request exceeded {REQUEST_HARD_TIMEOUT:.0f}s timeout",
            ),
        )
